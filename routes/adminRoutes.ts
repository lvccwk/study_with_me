...
async function findConfirmedSchedules(
	req: express.Request,
...
async function findPendingSchedules(
	req: express.Request,
	res: express.Response
) {
	try {
...
async function findAllStudents(req: express.Request, res: express.Response) {
	try {
        ...
        select student.id as student_id, users.* , image.image_icon
...
async function checkCrashedSchedule(
	req: express.Request,
	res: express.Response
) {
	try {
...
async function declineSchedule(req: express.Request, res: express.Response) {
	try {
		await client.query(`DELETE FROM bookings WHERE id = $1`, [
...
async function acceptSchedule(req: express.Request, res: express.Response) {
	try {
		await client.query(
			`UPDATE bookings SET teacher_status = 'confirm', booking_status = 'confirmed' WHERE id = $1`,
			[req.params.bookingId]
		)
		res.json('ok')
	} catch (error) {
